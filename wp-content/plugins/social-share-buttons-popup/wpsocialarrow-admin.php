...
function wpssi_settings_page()
{
  ...
  <form method="post" action="options.php" >
    ...
    <div id="main-container" class="margining">
      <div class="margining">
        <div class="margining">
          <div class="tabs-left">
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="a" style="height: 2650px;">
                ...
                <div id="wpsocialarrow-value">
                  ...
                  <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a>
                ...
                <div id="wpsocialarrow-value">
                  ...
                  <input id="wpsocialarrow-custom-default-message" name="" type="text" disabled placeholder="Set your custom message"/><span id="wpsocialarrow-custom-size-span"><a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a> (Add your custom message if don't use default ones)</span>
                ...
                <div id="wpsocialarrow-value">
                  ...
                  <div id="wpsocialarrow-label-value"><label id="wpsocialarrow-page-label">Show on Pages</label>
                    <div class="switch" style="margin-left: 180px;">
                      <input disabled id="wpsocialarrow-enable-page" name="" class="cmn-toggle cmn-toggle-round" type="checkbox" >
                      <label for="wpsocialarrow-enable-page"></label><a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a>
                    </div>
                  </div>
                  <div id="wpsocialarrow-label-value"><label id="wpsocialarrow-page-label">Show on Home Page</label>
                    <div class="switch" style="margin-left: 180px;">
                      <input disabled id="wpsocialarrow-enable-home" name="" class="cmn-toggle cmn-toggle-round" type="checkbox" >
                      <label for="wpsocialarrow-enable-home"></label><a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a>
                    </div>
                  </div>
                </div>
                ...
                <div id="wpsocialarrow-position-wrapper">
                  ...
                  <div id="wpsocialarrow-positioning">
                    <label for="beforepost"><a style="font-size: 15px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a><img src='<?php echo plugins_url( 'admin/images/beforepost.png', __FILE__); ?>' /></label><br/>
                    <input id="beforepost" disabled type="radio" name=""  />
                  </div>
                  <div id="wpsocialarrow-positioning">
                    <label for="both"><a style="font-size: 15px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a><img src='<?php echo plugins_url( 'admin/images/both.png', __FILE__); ?>' /></label><br/>
                  ...
                  <div id="wpsocialarrow-positioning">
                    <label for="aligncenter"><a style="font-size: 15px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a><img src='<?php echo plugins_url( 'admin/images/aligncenter.png', __FILE__); ?>' /></label><br/>
                    <input id="aligncenter" disabled type="radio"  />
                  </div>
                  <div id="wpsocialarrow-positioning">
                    <label for="alignright"><a style="font-size: 15px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Premium Feature</a><img src='<?php echo plugins_url( 'admin/images/alignright.png', __FILE__); ?>' /></label><br/>
                ...
                <div id="includedskin2">
                  <div class="col-md-12">
                    <input id="social-wide" disabled type="radio" name=""  /><label id="wpsocialarrow-skins-label" for="social-wide">  Social Wide <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
                    <div class="social1">
                      <a href="#" class="facebook" title="Facebook"></a>
                      <a href="#" class="twitter" title="Twitter"></a>
                      <a href="#" class="google" title="Google+"></a>
                ...
                <div id="includedskin3">
                  <div class="col-md-12">
                    <input id="bounce-up" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="bounce-up">  Flip Cards (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
                    <div class="social1" style="display: block !important;">
                ...
                <div id="includedskin4">
                  <div class="col-md-12">
                    <input id="grind-in" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="grind-in">  Roller (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
                ...
                <div id="includedskin5">
                  <div class="col-md-12">
                    <input id="paper-fold" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="paper-fold">  Paper Fold (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
            ...
            <div id="includedskin6">
              <div class="col-md-12">
                <input id="branded" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="branded">  Branded (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
        ...
        <div id="includedskin7">
          <div class="col-md-12">
            <input id="radiused" disabled type="radio"  /><label id="wpsocialarrow-skins-label" for="radiused">  Radiused (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
    ...
    <div id="includedskin8">
      <div class="col-md-12">
        <input id="octagon" disabled type="radio"  /><label id="wpsocialarrow-skins-label" for="octagon">  Octagon (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
...
<div id="includedskin9">
  <div class="col-md-12 ">
    <input id="hanging" disabled type="radio"  /><label id="wpsocialarrow-skins-label" for="hanging">  Hanging (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
...
<div id="includedskin10">
  <div class="col-md-12">
    <input id="tricon" disabled type="radio"  /><label id="wpsocialarrow-skins-label" for="tricon">  Tricon (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
...
<div id="includedskin11">
  <div class="col-md-12">
    <input id="hollow" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="hollow">  Hollow (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
...
<div id="includedskin12">
  <div class="col-md-12">
    <input id="sociallambs" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="sociallambs">  Social Lambs (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
...
<div id="includedskin13">
  <div class="col-md-12">
    <input id="3dicons" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="3dicons">  3D Icons (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
...
<div id="includedskin14">
  <div class="col-md-12">
    <input id="whitestitchedborder" disabled type="radio"  /><label id="wpsocialarrow-skins-label" for="whitestitchedborder">  White Stitched Border  (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
...
<div id="includedskin15"><div class="col-md-12">
  <input id="whiterounded" disabled type="radio" /><label id="wpsocialarrow-skins-label" for="whiterounded">  White Rounded (With Animation) <a style="font-size: 20px;margin-left: 10px;" target="_blank" href="https://www.arrowplugins.com/social-share">Locked</a> </label>
