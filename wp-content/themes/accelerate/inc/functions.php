...
function accelerate_scripts_styles_method() {
	...
	wp_enqueue_script( 'accelerate-bootstrap-css', ACCELERATE_JS_URL . '/bootstrap.min.js', array( 'jquery' ), false, true );
	

	wp_enqueue_style( 'accelerate-fontawesome', get_template_directory_uri() . '/fontawesome/css/font-awesome.css', array(), '4.7.0' );
	wp_enqueue_style( 'accelerate-bootstrap-js', get_template_directory_uri() . '/css/bootstrap.min.css');
    ...
    wp_enqueue_script( 'accelerate-angular-core', ACCELERATE_JS_URL . '/angular/angular.min.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-app', ACCELERATE_JS_URL . '/angular/app.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-post-service', ACCELERATE_JS_URL . '/angular/services/postService.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-home-controller', ACCELERATE_JS_URL . '/angular/controllers/homeController.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-navigation-controller', ACCELERATE_JS_URL . '/angular/controllers/navigationController.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-archive-controller', ACCELERATE_JS_URL . '/angular/controllers/archiveController.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-search-controller', ACCELERATE_JS_URL . '/angular/controllers/searchController.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-post-card-directive', ACCELERATE_JS_URL . '/angular/directives/postCard.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-loading-directive', ACCELERATE_JS_URL . '/angular/directives/loading.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-follow-us-directive', ACCELERATE_JS_URL . '/angular/directives/followUs.js', array(), false, true);
    wp_enqueue_script( 'accelerate-angular-hero-posts-directive', ACCELERATE_JS_URL . '/angular/directives/heroPosts.js', array(), false, true);
}
...
if ( ! function_exists( 'accelerate_entry_meta' ) ) :
	function accelerate_entry_meta() {
		...
		$categories_list = get_the_category_list( __( '<i class="fa fa-chevron-right" style="font-size: 60%"></i>', 'accelerate' ) );
		if ( $categories_list ) {
...
if ( !function_exists('charity_post_card') ) {
    function charity_post_card($post, $col_class = 'col-sm-4') { ?>
        <div class="<?php echo $col_class ?> post-card">
            <div class="post-card-container">
                <center>
                    <img class="post-card-image" src="<?php echo get_post_first_image($post->post_content) ?>">
                </center>
                <div class="post-card-content">
                    <h4><?php echo $post->post_title; ?></h4>
                    <div ng-bind-html="<?php echo $post->post_excerpt; ?>"></div>
                    <a class="new-read-more" href="<?php echo get_permalink($post->ID); ?>">Read More</a>
                </div>
            </div>
        </div>
    <?php
...
if ( !function_exists('get_post_first_image') ) {
    function get_post_first_image($content) {
